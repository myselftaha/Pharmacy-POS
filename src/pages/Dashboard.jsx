    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                // 1. Fetch Accurate Backend Stats
                ...
                // Note: /api/transactions supports startDate/endDate query params too
                const txResponse = await fetch(`http://localhost:5000/api/transactions?startDate=${startDate}&endDate=${endDate}`);
                ...
                <div className="flex gap-4 items-center">
                    ...
                    <div className="relative">
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2.5 bg-[#10b981] text-white border border-[#10b981] rounded-lg font-bold hover:bg-[#0da070] transition-all shadow-sm active:scale-95"
                        >
