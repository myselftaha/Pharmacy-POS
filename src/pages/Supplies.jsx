                        ...
                        <table className="w-full text-left border-collapse">
                            <thead className="bg-gray-50 sticky top-0 z-10">
                                <tr>
                                    ...
                                    <th
                                        className="px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider text-right cursor-pointer hover:bg-gray-100"
                                        onClick={() => handleSort('totalPayable')}
                                    >
                                        Balance {sortConfig.key === 'totalPayable' && (sortConfig.direction === 'asc' ? '↑' : '↓')}
                                    </th>
                                    ...
                                    sortedSuppliers.map((supplier) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4 text-right">
                                                <span className={`inline-block px-3 py-1 rounded-full text-sm font-bold ${supplier.totalPayable > 0 ? 'bg-red-100 text-red-600' :
                                                    supplier.totalPayable < 0 ? 'bg-yellow-100 text-yellow-700' :
                                                        'bg-gray-100 text-gray-600'
                                                    }`}>
                                                    {supplier.totalPayable > 0 ? 'Payable' :
                                                        supplier.totalPayable < 0 ? 'Advance' : 'Settled'}
                                                    <span className="ml-1">
